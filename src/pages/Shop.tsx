...
import { useEffect, useState, useCallback, JSX, ChangeEvent } from "react";
...
export default function Shop(): JSX.Element {
  ...
  const [filterOpen, setFilterOpen] = useState<boolean>(false); // mobile filter sheet
...
function ActiveFilterPill({ label, onRemove }: { label: string; onRemove: () => void }): JSX.Element {
